...
import com.sumberbola.Interface.RequestInggris;
...
public class InggrisFragment extends Fragment {
    ...
    private void loadJSON(){
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .build();
        RequestInggris request = retrofit.create(RequestInggris.class);
